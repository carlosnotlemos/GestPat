...
ActiveRecord::Schema[7.1].define(version: 2025_12_31_032050) do
  ...
  create_table "inventories", force: :cascade do |t|
    ...
    t.index ["tenant_id", "location_id", "checked_at"], name: "index_inventories_on_tenant_id_and_location_id_and_checked_at"
